...
export function SiteHeader({
  ...
  return (
    <header className="flex [height:var(--header-height)] shrink-0 items-center border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:[height:var(--header-height)]">
