...
import { UpdateCouponSchema } from "@instello/db/lms";
...
export function EditCouponDialog({
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      subscriptionDurationDays: coupon.subscriptionDurationDays,
      type: coupon.type,
      valid: coupon.valid,
    },
  });
  ...
  async function onSubmit(values: z.infer<typeof UpdateCouponSchema>) {
    await updateCoupon({
      id: coupon.id,
      ...values,
    });
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-base">Edit Coupon</DialogTitle>
        </DialogHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Only specified number of students can use this coupon
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
